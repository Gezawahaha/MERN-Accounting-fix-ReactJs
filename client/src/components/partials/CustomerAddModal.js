...
class CustomerAddModal extends React.Component {
    ...
    onCustomerAdd = e => {
        ...
        this.props.addCustomer(newCustomer , this.props.history);
    ...
    getDataIDcust() {
        axios.get('/customer/Cust-data')
        .then(response => {
            if (response.data.length < 10) {
                this.setState({
                    CustomerID: `00${response.data.length + 1}`
                ...
                this.setState({
                    CustomerID: `0${response.data.length + 1}`
    ...
    render() {
        ...
        return (
            <div>
                <div className="modal fade" id="add-customer-modal" data-reset="true">
                    <div className="modal-dialog modal-lg">
                        <div className="modal-content">
                            ...
                            <div className="modal-body">
                                <form noValidate onSubmit={this.onCustomerAdd} id="add-Cust">
                                    <div className="row mt-2">
                                        <div className="col-md-3">
                                            <label htmlFor="name">CustomerID</label>
                                        </div>
                                        <div className="col-md-9">
                                        <small>{ `#${this.state.CustomerID}`}</small>
                                        ...
                                        <div className="col-md-9">
                                            <ReactSelect
                                                type="string"
                                                 ...
                                                 getOptionLabel={option => <Fragment>{`${option.FirstName} ${option.LastName}`}</Fragment>}
